...
CREATE TABLE IF NOT EXISTS bot_config(
    lara_name TEXT DEFAULT 'LITTLE NUCKY',                 -- Nome da lara
    lara_key TEXT DEFAULT '@RepositorioDoNucky',                                        -- Chave pix da lara
    bot_compra TEXT DEFAULT 'https://a.imagem.app/o3BDGE.jpeg',  -- Link da imagem do /comprar
    main_img TEXT DEFAULT 'https://a.imagem.app/o3BDGE.jpeg',  -- Link da imagem do /start
    support_user TEXT DEFAULT '@LittleNucky',                               -- Username de atendimento
    channel_user TEXT DEFAULT '@RepositorioDoNucky',                                    -- Canal de notícias
