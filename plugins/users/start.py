...
async def start(c: Client, m: Union[Message, CallbackQuery]):
    ...
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                ...
                InlineKeyboardButton("🥇 DONO", url='https://t.me/Eyebl4ck'),
            ],
        ]
    )
    ...
    start_message = f"""<a href="{bot_logo}">💳</a><b>Olá, {m.from_user.first_name} SEJA BEM VINDO A STORE DO @Eyebl4ck COMPRE SUAS INFOCC'S ABAIXO!</b>

<b>⚠️ - Por Favor Leia Os Termos De Trocas Em: ♻️ Termos!</b>

<b>💸 - Agilisamos o Processo De Adição De Saldo, Basta Usar <code>/pix</code> Com o Valor Desejado e Adicionar Seu Saldo!! APROVEITE</b>
