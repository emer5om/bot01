...
async def ferramentas(c: Client, m: Union[Message, CallbackQuery]):
    ...
    kb = InlineKeyboardMarkup(
        inline_keyboard=[
            [
                InlineKeyboardButton(text="⬅️ Menu Principal", callback_data="user_info"),
            ],
        ]
    )
...
<code>/separador</code> <b>- Separa suas ccs em seu formato correto para venda ou datebases.</b>
"""
